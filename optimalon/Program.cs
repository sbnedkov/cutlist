    ...
    static void Main(string[] args)
    {
      try {
        ...
        if (result == "") {
          ...
          string Txt;
          Console.WriteLine("Used {0} stocks", Calculator.UsedStockCount);
          ...
          for (iLayout = 0; iLayout < Calculator.LayoutCount; iLayout++) {
            ...
            for (iStock = stockIndex; iStock < stockIndex + stockCount; iStock++) {
              ...
              Console.WriteLine("Stock={0}: Width={1}; Height={2}", iStock, width, height);
              ...
              for (iPart = 0; iPart < partCount; iPart++) {
                ...
                Console.WriteLine("Part={0}; stock={1}; Width={2}; Height={3}; X={4}; Y={5}; R={6}", partIndex, iStock, W, H, X, Y, rotated);
              }
            }
          }
        } else {
